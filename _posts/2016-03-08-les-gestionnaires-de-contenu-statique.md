...
{% include_cached figure.html url="/assets/img/2016/03/cloudcannon-editor.png" description="L'éditeur de contenu de Cloudcannon" %}
...
{% include_cached figure.html url="/assets/img/2016/03/jekyll-terminal.png" description="Jekyll en action dans le terminal" %}
...
{% include_cached figure.html url="/assets/img/2016/03/macdown.png" description="Aperçu de cet article dans MacDown" %}
